...
@Component(name = "ApplicationController", provide = { StackPane.class, EventHandler.class }, configurationPolicy = ConfigurationPolicy.require)
public class ApplicationController extends StackPane implements Initializable, EventHandler {
